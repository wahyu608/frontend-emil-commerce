...
const Modal = ({ isOpen, onClose, product, quantity, onIncrease, onDecrease, onConfirm }) => {
      ...
      <div className="bg-white rounded-lg overflow-hidden shadow-lg w-11/12 md:w-1/3">
        <div className="p-4 relative">
          ...
          <div className="flex flex-col items-center">
            ...
            <button onClick={onConfirm} className="bg-gray-800 text-white px-6 py-2 rounded-lg">Masukan ke Keranjang</button>
          </div>
        </div>
      </div>
    </div>
