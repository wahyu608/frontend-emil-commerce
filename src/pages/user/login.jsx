      ...
      <div className="w-full sm:w-2/3 bg-white h-full flex justify-center items-center">
        <div className="w-full pb-72 sm:-mr-40 max-w-sm flex flex-col justify-center items-center pt-32">
          ...
          <form className="flex flex-col gap-4 w-full justify-center" >
            ...
            <Input variant="h-10 bg-custom-coklat rounded-3xl text-white border text-center placeholder-white  border-gray-300 placeholder: opacity-50 focus:opacity-100 outline-none" type="text" name="password" id="password" placeholder="******" />
            <Button variant="h-10 sm:mt-2 text-white bg-stone-400 hover:bg-stone-600  rounded-3xl w-1/2 sm:relative sm:ml-24 ">Login</Button>
            <a className="text-center" href="/register">belum punya akun?</a>
          </form>
        </div>  
      </div>
    </div>
